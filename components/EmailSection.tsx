    ...
    >
      <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary-900 to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -left-4 transform -translate-x-1/2 -translate-1/2">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          {' '}
          I always look forward to chatting about exciting new opportunities.
          Leave me a message - even if it&apos;s just to say hi!
        </p>
      </div>
      <div>
        {emailSubmitted ? (
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                id="message"
                className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
                placeholder="Just kidding, I only wanted to say hi <3"
              />
            </div>
            <button
              type="submit"
